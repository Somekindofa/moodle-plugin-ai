            ...
            while (1) switch (_context2.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                  var aiMessageDiv, responseSpan, url, options, response, reader, decoder, responseContent, _yield$reader$read, done, value, chunk, lines, _iterator, _step, line, data, parsed, content, htmlContent, _t, _t2;
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.p = _context.n) {
                      ...
                      case 16:
                        _context.p = 16;
                        _t2 = _context.v;
                        console.error('Fireworks API call failed:', _t2);
                        responseSpan.textContent = 'Sorry, there was an error processing your request: ' + _t2.message;
                      case 17:
            ...
            while (1) switch (_context4.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
                  var aiMessageDiv, responseSpan, modelToUse, url, options, response, reader, decoder, responseContent, _yield$reader$read2, done, value, chunk, lines, _iterator2, _step2, line, data, parsed, content, htmlContent, _t3, _t4, _t5;
                  return _regenerator().w(function (_context3) {
                    while (1) switch (_context3.p = _context3.n) {
                      ...
                      case 19:
                        _context3.p = 19;
                        _t5 = _context3.v;
                        console.error('Claude API call failed:', _t5);
                        responseSpan.textContent = 'Sorry, there was an error processing your request: ' + _t5.message;
                      case 20:
                        // Final scroll to bottom
                        messagesContainer.scrollTop = messagesContainer.scrollHeight;
                      case 21:
                  ...
                  }, _callee3, null, [[9, 12], [7, 15, 16, 17], [1, 19]]);
                })), 1000);
              case 1:
