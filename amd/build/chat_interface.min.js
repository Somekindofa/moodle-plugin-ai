            ...
            while (1) switch (_context4.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
                  var aiMessageDiv, responseSpan, modelToUse, url, options, response, data, content, htmlContent, _t2;
                    ...
                    while (1) switch (_context3.p = _context3.n) {
                      ...
                      case 3:
                        ...
                        if (data.content && data.content[0] && data.content[0].text) {
                          content = data.content[0].text; // Convert markdown to HTML if marked is available
                          if (typeof marked !== 'undefined' && marked.parse) {
                            htmlContent = marked.parse(content);
                            responseSpan.innerHTML = htmlContent;
                          } else {
