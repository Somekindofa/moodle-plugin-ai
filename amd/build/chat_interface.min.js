 ...
 */
  ...
  var init = _exports.init = function init() {
    ...
    var initializeChat = function initializeChat() {
      ...
      var toggleSidebarBtn = document.getElementById("ai-toggle-sidebar");
      var closeSidebarBtn = document.getElementById("ai-close-sidebar");
      var documentsSidebar = document.getElementById("ai-documents-sidebar");
      ...
      function populateDocumentsSidebar(documents) {
        ...
        var documentsHtml = documents.map(function (doc) {
          return "\n                <div class=\"document-item\">\n                    <div class=\"doc-title\">".concat(doc.title || 'Untitled Document', "</div>\n                </div>\n            ");
        }).join('');
