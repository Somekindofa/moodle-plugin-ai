            ...
            while (1) switch (_context2.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                  var aiMessageDiv, responseSpan, url, options, response, errorData, reader, decoder, responseContent, hasReceivedContent, _yield$reader$read, done, value, chunk, lines, _iterator, _step, line, data, parsed, content, htmlContent, _t, _t2, _t3;
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.p = _context.n) {
                        ...
                        if (parsed.choices && parsed.choices[0] && parsed.choices[0].delta) {
                          ...
                          if (content) {
                            ...
                            if (typeof marked !== 'undefined' && marked.parse) {
                              htmlContent = marked.parse(responseContent);
                      ...
                      case 21:
                        _context.p = 21;
                        _t3 = _context.v;
                        console.error('Fireworks API call failed:', _t3);
                  ...
                  }, _callee, null, [[11, 13], [9, 16, 17, 18], [5,, 19, 20], [1, 21]]);
                })), 1000);
              case 1:
            ...
            while (1) switch (_context4.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
                  var aiMessageDiv, responseSpan, modelToUse, url, options, response, errorData, reader, decoder, responseContent, hasReceivedContent, _yield$reader$read2, done, value, chunk, lines, _iterator2, _step2, line, data, parsed, content, htmlContent, _t4, _t5, _t6;
                  return _regenerator().w(function (_context3) {
                    while (1) switch (_context3.p = _context3.n) {
                      ...
                      case 21:
                        _context3.p = 21;
                        _t6 = _context3.v;
                        console.error('Claude API call failed:', _t6);
                        responseSpan.textContent = 'Sorry, there was an error processing your request: ' + _t6.message;
                      case 22:
                        // Final scroll to bottom
                        messagesContainer.scrollTop = messagesContainer.scrollHeight;
                      case 23:
                  ...
                  }, _callee3, null, [[11, 13], [9, 16, 17, 18], [5,, 19, 20], [1, 21]]);
                })), 1000);
              case 1:
