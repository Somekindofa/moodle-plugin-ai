            ...
            while (1) switch (_context2.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                  var aiMessageDiv, responseSpan, url, options, response, reader, decoder, accumulatedText, lastProcessedLength, parseTimeout, PARSE_DELAY, _yield$reader$read, done, value, lines, _iterator, _step, line, data, htmlContent, _t, _t2, _t3;
                  return _regenerator().w(function (_context) {
                    while (1) switch (_context.p = _context.n) {
                      ...
                      case 3:
                        ...
                        accumulatedText = '';
                        lastProcessedLength = 0; // Debouncing variables for performance
                        parseTimeout = null;
                        PARSE_DELAY = 100; // ms
                      case 4:
                        if (!true) {
