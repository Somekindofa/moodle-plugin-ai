            ...
            while (1) switch (_context2.n) {
              case 0:
                setTimeout(/*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
                  var aiMessageDiv, responseSpan, url, options, response, aiResponse, retrievedDocuments, documentsProcessed, last_ai_message_content, reader, decoder, _yield$reader$read, done, value, lines, _iterator, _step, line, data, document_sources, _iterator2, _step2, msg, current_ai_content, html_content, _html_content, _t, _t2, _t3;
                    ...
                    while (1) switch (_context.p = _context.n) {
                      ...
                      case 10:
                        ...
                        if (data.messages && Array.isArray(data.messages)) {
                          ...
                          _iterator2 = _createForOfIteratorHelper(data.messages);
                          try {
                            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                              ...
                              if (msg.content && (msg.type === 'ai' || msg.__class__ === 'AIMessage' || typeof msg.content === 'string')) {
                                current_ai_content = msg.content; // Only update if the AI message content has changed
                                if (current_ai_content !== last_ai_message_content) {
                                  ...
                                  if (typeof marked !== 'undefined' && marked.parse) {
                                    html_content = marked.parse(response_span.textContent);
                        ...
                        // Fallback for stream_mode="messages" (direct string content)
                          ...
                          // Convert markdown to HTML if marked is available
                          if (typeof marked !== 'undefined' && marked.parse) {
                            _html_content = marked.parse(response_span.textContent);
                            response_span.innerHTML = _html_content;
                          }
                        }
                        if (!data.error) {
                          _context.n = 11;
